...
(function (ADL) {
    ...
    var Config = function()
    {
        var key='flQunzOGP_vjn9TE4N4'
        var secret ='cLWmEhkIPZE_xXoKk8Q'
        var conf = {};
        conf['endpoint'] = "https://cloud.scorm.com/lrs/INDFKJWFDA/sandbox/";
        //try
        //{
            conf['auth'] = "Basic " + toBase64(key+':'+secret);
        //}
        //catch (e)
        //{
